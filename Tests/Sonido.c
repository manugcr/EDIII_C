...
//uint16_t sinSamples[NUM_SINE_SAMPLE] = {511, 564, 617, 669, 719, 767, 812, 853, 891, 925, 954, 978, 997, 1011, 1020, 1023,
...
uint16_t sinSamples[NUM_SINE_SAMPLE] =
{
...
void ADC_IRQHandler()
{
	...
	ADCVALMAP	= map(ADCVAL, 0, 1024, 20, 300);

	GPDMA_ChannelCmd(0, DISABLE);
	DAC_SetDMATimeOut(LPC_DAC, ((PCLK_DAC_IN_MHZ * 1000000)/(ADCVALMAP * NUM_SINE_SAMPLE)));
	configDMA();
